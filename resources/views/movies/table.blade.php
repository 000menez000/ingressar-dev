            ...
            <div
                ...
                <div
                    ...
                    <button type="button" id="createProductButton"
                        onclick="window.location='{{ route('hubflix.movies.create') }}'"
                    ...
                    <button type="button" data-modal-target="delete-modal-selected" data-modal-toggle="delete-modal-selected"
                    ...
                    <!-- Delete Modal -->
                    <div id="delete-modal-selected" tabindex="-1"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                        Você tem certeza que quer deletar esse filme?</h3>
                                    <form method="POST"
                                        {{-- action="{{ route('hubflix.movies.destroy', $movie->movie_id) }}">
                                        @csrf
                                        @method('DELETE') --}}
                                        <button type="submit"
                                            class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">Sim,
                                            eu preciso</button>
                                        <button data-modal-toggle="delete-modal-selected" type="button"
                            ...
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <button type="button" data-modal-target="delete-modal-{{ $movie->movie_id }}"
                                            data-modal-toggle="delete-modal-{{ $movie->movie_id }}"
                                            class="flex items-center text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 -ml-0.5"
                                                viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                <path fill-rule="evenodd"
                                        ...
                                        <!-- Delete Modal -->
                                        <div id="delete-modal-{{ $movie->movie_id }}" tabindex="-1"
                                            class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative w-full h-auto max-w-md max-h-full">
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    <button type="button"
                                                    ...
                                                    <div class="p-6 text-center">
                                                        ...
                                                        <form method="POST"
                                                            ...
                                                            <button type="submit"
                                                                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">Sim,
                                                                eu preciso</button>
                                                            <button data-modal-toggle="delete-modal-{{ $movie->movie_id }}"
                                                                type="button"
                                                                class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Não,
                                                                cancelar</button>
                                                        </form>
